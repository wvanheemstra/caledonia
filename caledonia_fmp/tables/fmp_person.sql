...
-- ----------------------------
--  Table structure for `fmp_person`
-- ----------------------------
DROP TABLE IF EXISTS `fmp_person`;
CREATE TABLE `fmp_person` (
